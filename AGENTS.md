...
This file contains repository-specific working guidance for coding agents collaborating on **mma-prediction-betting-system**.

## Project Snapshot
- Repository: `mma-prediction-betting-system`
- Path: `/home/igorkan/repos/mma-prediction-betting-system`
- Purpose: Repository for Mma outcome prediction and betting workflows using publicly available data.
- Primary Stack: Python

## External Research Signals
- Origin Remote: `https://github.com/igor-kan/mma-prediction-betting-system.git`
- GitHub Slug: `igor-kan/mma-prediction-betting-system`
- GitHub Description: Not available
- GitHub Homepage: Not set
- GitHub Topics: None detected
- GitHub Last Push Timestamp: 2026-04-21T21:09:02Z
