...
Repository-specific working guide for coding agents on **Mma Prediction and Betting System**.

## Snapshot
- Repository: `mma-prediction-betting-system`
- Path: `/home/igorkan/repos/mma-prediction-betting-system`
- Purpose: Production-oriented repository for Mma outcome prediction and betting execution using publicly available data.
